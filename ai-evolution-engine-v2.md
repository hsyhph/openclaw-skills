...
**英文名**: ai-evolution-engine-v2  
**描述**: AI 自动化引擎 V2  
**来源**: ClawHub Stars 排行热门技能

---

## 📖 使用说明

本技能来自 ClawHub 技能市场（Stars 排行热门）。

```
# 安装技能
clawhub install ai-evolution-engine-v2

# 或强制安装
clawhub install ai-evolution-engine-v2 --force
```
